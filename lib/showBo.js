...
//    	  '<div class="avtar"><img src="images/avtar.png"></div>'+
    ...
    onResize:function(isResize){  
       ...
       if(Showbo.BodyScale.tx <=500){
         Showbo.Msg.dvMsgBox.style.width='300px';
       }
       else if(Showbo.BodyScale.tx <=768){
//    	   alert("height: " +  document.documentElement.clientHeight);
    	   Showbo.Msg.dvMsgBox.style.width='350px';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }else if(Showbo.BodyScale.tx <=992){
    	   Showbo.Msg.dvMsgBox.style.width='370px';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }else if(Showbo.BodyScale.tx <=1200){
    	   Showbo.Msg.dvMsgBox.style.width='380px';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }else{
    	   Showbo.Msg.dvMsgBox.style.width='400px';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }
